  ...
  Circle: function (x, y, dx, dy, radius, fill) {
    ...
    this.update = function () {
      ...
      if (Stars.mouse.x - this.x < Stars.mouseDistance && Stars.mouse.x - this.x > -Stars.mouseDistance && Stars.mouse.y - this.y < Stars.mouseDistance && Stars.mouse.y - this.y > -Stars.mouseDistance) {
        if (this.radius < Stars.maxRadius) this.radius += 0.7;
...
var imgData = ' data:image/png;base64,h0zmU6Z1SWldUSlct/atoZkLPRjIsKF/Sll5+k6S9cJskxipSORhkwnCCJ5MWR39xxZPkQZyWQy5YHdKbdX651GxmbmBgYGBgVzII3MDAwMDArmQQuIGBgYGBXckgcAMDAwMDu5JB4AYGBgYGdiWDwA0MDAwM7EoGgRsYGBgY2JX8/yqc4O5DWWtcAAAAAElFTkSuQmCC';
